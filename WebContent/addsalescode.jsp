	...
	try {
		if(submittype.equals("Add")){
			...
			if(defaultquantity < Integer.parseInt(quantity)){
				...
				String str = "INSERT INTO sales_info(dispatch_date,bill_to,ship_to,invoice,shipped_by,tracking,entry_by) VALUES('"
						+ orderdate + "'," + billto + ","+shipto+",'"+invoice+"','"+shippedby+"','"+tracking+"','"+username+"')";	
			...
			String str = "UPDATE sales_info SET dispatch_date='"+orderdate+"',bill_to="+billto+",ship_to="+shipto+",invoice='"+invoice+"',shipped_by='"+shippedby+"',tracking='"+tracking+"' WHERE sales_id="+id;
			i = st.executeUpdate(str);
			if(i > 0){
